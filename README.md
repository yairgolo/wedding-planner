...
ייבוא Excel/CSV מקבל רשומות ועמודות חלקיות, כולל ללא צורת פנייה.
לשליחה יש להשלים שם פרטי, צד וצורת פנייה; אין ניחוש אוטומטי של צורת הפנייה.
בעדכון לפי מזהה שדות ריקים משאירים את המידע הקיים. בייבוא אישי צד חסר
משויך לצד של השולח; בייבוא מנהל נשאר ללא שיוך ונראה רק למנהל עד להשלמת הצד.
